...
import { errorHandler } from "./api/http/middleware/error-handler.js";
import { env } from "./config/env.js";
import v1Routes from "./api/http/routes/index.js";
import discoveryRoutes from "./api/http/routes/discovery.routes.js";
import internalRoutes from "./api/http/routes/internal-routes.js";
import { handleMcpRequest, handleMcpSse, handleMcpMessage } from "./api/mcp/index.js";
import { mcpAuthMiddleware } from "./api/mcp/auth.js";
import { BullMQOutboxWorker } from "./infrastructure/queue/bullmq-worker.js";
import { OutboxRepository } from "./infrastructure/database/repositories/outbox.repository.js";
import { createPaymentReconciliationHandler } from "./modules/payment/reconciliation.js";
import { createCommerceMissionHandler } from "./modules/commerce/mission-handler.js";
import { PrismaClient } from "@prisma/client";
import { OutboxPublisher } from "./infrastructure/queue/publisher.js";
...
app.listen(env.server.port, env.server.host, () => {
  ...
  worker.registerHandler('commerce.mission.requested', createCommerceMissionHandler(prisma));
  worker.start();
